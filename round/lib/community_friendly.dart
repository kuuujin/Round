...
class CommunityFriendlyScreen extends StatefulWidget {
  final String userId;
  const CommunityFriendlyScreen({super.key, required this.userId});

  @override
  State<CommunityFriendlyScreen> createState() => _CommunityFriendlyScreenState();
}

class _CommunityFriendlyScreenState extends State<CommunityFriendlyScreen> {
